...
| Week | 주제                  | 이론 및 강의 내                                                     | 실습                                                                                                                               | 강의자료                                                                   |
| ---- | ------------------- | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| 1    | 통계 기초 및 데이터 이해      | 평균, 분산, 데이터 종류, 통계량<br>데이터 정규화 필요성                    | 데이터 스케일링<br>기초 통계량 계산 | 1_statistics for machine learning.pptx |
| 2    | 통계 기초 및 데이터 이해      | 평균, 분산, 히스토그램과 박스상자 그림, 공분산, 상관관계<br>데이터 정규화 필요성                    | 기초 통계량 계산 | 1_statistics for machine learning.pptx |
| 3    | 동시확률과 조건부 확률      | 히스토그램과 KDE, 조건부확률, 동시확률, 이상치 분석                    | solution_02_Joint_kernel_density_anomaly_detection.ipynb<br>Unsupervised_clustering_Kmeans_DBSCAN.ipynb | 2_histogram2probability.pptx |
| 4    | 확률론 기초              | 확률변수와 확률분포<br>이산/연속 확률분포<br>기댓값과 분산                           | 난수 생성<br>확률분포 시각화                                                                                                                |   3_probability theory for machine learning.pptx                                                                     |

| 3    | 선형대수 I – 벡터와 행렬     | 벡터, 행렬, 스칼라<br>내적, 외적<br>행렬 곱                                 | NumPy 행렬 연산<br>브로드캐스팅 이해                                                                                                         |                                                                        |
| 4    | 선형대수 II – 선형변환과 고유값 | 선형변환 개념<br>고유값·고유벡터<br>PCA 직관, 차원축소(Dimension Reduction) 알고리즘 | 고유값 분해 실습<br>간단한 PCA 구현                                                                                                          |                                                                        |
| 5    | 딥러닝 개요 및 수학적 기초     | 딥러닝 발전 배경 및 활용 분야<br>머신러닝 vs 딥러닝<br>수학 로드맵 정리                 | Python / NumPy 복습<br>벡터·행렬 연산                                                                                                    |                                                                        |
