...
| ---- | ------------------- | -------------------------------------------------------- | ------------------------------- |
| 1    | 통계 기초 및 데이터 이해      | 평균, 분산, 공분산<br>정규분포와 중심극한정리<br>데이터 정규화 필요성              | 데이터 스케일링<br>기초 통계량 계산  <br> solution_02_Joint_kernel_density_anomaly_detection.ipynb<br>Unsupervised_clustering_Kmeans_DBSCAN.ipynb         | 1_statistics for machine learning.pptx <br> 2_histogram2probability.pptx|
